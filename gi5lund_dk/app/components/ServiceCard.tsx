...
export default function ServiceCard({ title, desc, href, icon }: Props) {
  return (
    <Link href={href} className="group">
      <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all duration-300 hover:-translate-y-2 hover:border-sky-400 hover:scale-105">
